...
def test_read_main():
    ...
    It also asserts that the JSON response matches the expected message "Hello World".

    Returns:
        None

    Raises:
        AssertionError: If the response status code is not 200 or if the JSON response does not match the expected message.
    """
    response = client.get("/")
...
def test_translate_en_ru_ok():
    ...
    Raises:
        AssertionError: If the status code is not 200 or the JSON response does not contain the expected translation text.
    """
...
def test_translate_en_ru_error():
    ...
    Raises:
        AssertionError: If the status code is not 200 or the JSON response matches the incorrect translation.
    """
    response = client.post(
        "/translation_en_to_ru/",
        json={"text": "hello"}
...
def test_translate_en_ru_error_not_200():
    ...
    Raises:
        AssertionError: If the status code is not 422, indicating that the endpoint did not handle the error as expected.
    """
    response = client.post(
        "/translation_en_to_ru/",
        json={"message": "hello"}
